...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #0f3460 100%); min-height: 100vh; padding: 20px; color: #e0e0e0;">
  <div style="max-width: 1400px; margin: 0 auto;">
    ...
    <div style="display: flex; justify-content: space-around; flex-wrap: wrap; gap: 15px; margin-bottom: 30px;">
      <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 20px; min-width: 200px; flex: 1; backdrop-filter: blur(10px);">
        <h3 style="color: #8be9fd; font-size: 0.9em; margin-bottom: 10px; text-transform: uppercase;">Today's Activity</h3>
        <div style="font-size: 2em; color: #50fa7b; font-weight: bold;">{todayActivity}</div>
      </div>
      <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 20px; min-width: 200px; flex: 1; backdrop-filter: blur(10px);">
        <h3 style="color: #8be9fd; font-size: 0.9em; margin-bottom: 10px; text-transform: uppercase;">Total Snapshots</h3>
        <div style="font-size: 2em; color: #50fa7b; font-weight: bold;">{snapshotCount}</div>
      </div>
      <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 20px; min-width: 200px; flex: 1; backdrop-filter: blur(10px);">
        <h3 style="color: #8be9fd; font-size: 0.9em; margin-bottom: 10px; text-transform: uppercase;">Database Events</h3>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 20px;">
      <!-- Live Stream -->
      <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 20px; backdrop-filter: blur(10px); grid-column: 1 / -1;">
        <h2 style="color: #ff79c6; margin-bottom: 20px; font-size: 1.3em; border-bottom: 2px solid rgba(255, 255, 255, 0.1); padding-bottom: 10px;">
          🎥 Live Stream with Zones
        </h2>
        <div style="position: relative; width: 100%; aspect-ratio: 16/9; background: #000; border-radius: 8px; overflow: hidden; margin-bottom: 10px;">
          <video
        ...
        <p style="margin-top: 10px; color: #8be9fd; font-size: 0.9em;">🟢 Feeding Station | 🟠 Basking Spot | 🔵 Hide Box</p>
      </div>
      ...
      <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 20px; backdrop-filter: blur(10px); grid-column: 1 / -1;">
        ...
        <div style="display: flex; gap: 10px; margin-bottom: 15px;">
          <button on:click={prevSnapshots} style="background: #50fa7b; color: #1a1a2e; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-weight: bold;">
            ⬅ Newer
          </button>
          <button on:click={nextSnapshots} style="background: #50fa7b; color: #1a1a2e; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-weight: bold;">
            Older ➡
          </button>
          ...
          {#if snapshots.length > 0}
            {#each snapshots as snap (snap.filename)}
              ...
              >
                ...
                />
                <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(transparent, rgba(0, 0, 0, 0.9)); padding: 10px; font-size: 0.85em;">
      ...
      <!-- Zones -->
      <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 20px; backdrop-filter: blur(10px);">
        <h2 style="color: #ff79c6; margin-bottom: 20px; font-size: 1.3em; border-bottom: 2px solid rgba(255, 255, 255, 0.1); padding-bottom: 10px;">
          🗺️ Defined Zones
        </h2>
        <div style="display: flex; flex-direction: column; gap: 10px;">
          {#if zones.length > 0}
            {#each zones as zone}
              <div style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.03); border-radius: 5px;">
                <div
                  style="width: 20px; height: 20px; border-radius: 50%; margin-right: 10px; background-color: rgb({zone.color[0]}, {zone.color[1]}, {zone.color[2]});"
                />
