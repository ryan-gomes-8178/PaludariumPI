  ...
  },
  {
    ...
    subroutes: [
      ...
      },
      {
        ...
        breadcrumb: ['Home'],
        icon: 'fas fa-tint',
        hide: settings.show_gauge_overview !== true,
      },
    ],
  },
  {
    ...
    nesting: true,
    subroutes: [
      ...settings.available_sensor_types.map((sensor_type) => {
        return {
...
export const onRouteLoaded = async (route) => {
  ...
  pageTitle.set(typeof page.title === 'function' ? await page.title() : page.title);
};
